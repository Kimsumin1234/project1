...
@Log4j2
public class SearchReivewRepositoryImpl extends QuerydslRepositorySupport implements SearchReviewRepository {
    ...
    public Page<Object[]> list(String type, String keyword, Pageable pageable) {
        ...
        sort.stream().forEach(order -> {
            ...
            PathBuilder<Review> orderByExpression = new PathBuilder<>(Review.class, "review");
