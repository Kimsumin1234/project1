...
public interface ReviewRepository
    ...
    @Query(value = "SELECT r1_0.rno, r1_0.created_date, r1_0.last_modified_date, r1_0.text, r1_0.title, r1_0.view_count, r1_0.writer_mid, r1_0.heart_count FROM review r1_0 LEFT JOIN heart h1_0 ON r1_0.rno = h1_0.review_rno WHERE h1_0.hno =?1", nativeQuery = true)
