...
import com.example.project1.dto.UploadResultDto;
import java.io.File;
...
public class UploadController {
  ...
  private String uploadPath; // /home/ec2-user/app/upload EC2 서버에 업로드
  ...
  public ResponseEntity<List<UploadResultDto>> postMethodName(
